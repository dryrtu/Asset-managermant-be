...
//                .antMatchers(HttpMethod.GET, "/api/v1/users/**", "/api/v1/**").hasAnyAuthority(Roles.ADMIN.toString())
//                .antMatchers(HttpMethod.POST, "/api/v1/users/**", "/api/v1/**").hasAnyAuthority(Roles.ADMIN.toString())
